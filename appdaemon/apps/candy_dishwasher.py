...
appliance_ip = 'candy-dw.lan'               # The IP address of the appliance
appliance_entity = 'sensor.dishwasher'      # The name of the entity to use/create in Home Assistant (the stats use the same value with '_stats' appended)
...
encryption_key = 'bikfehggfjhefili'         # The encryption key obtained from your appliance
...
class CandyDishwasher(hass.Hass):
    def initialize(self):
